...
(cd ../mserviceA;   ./mvnw clean package verify -Djib-maven-plugin.architecture=arm64 jib:dockerBuild) && P0=$!
(cd ../mserviceB;   ./mvnw clean package verify -Djib-maven-plugin.architecture=arm64 jib:dockerBuild) && P1=$!
